...
As the site owner of this imaginary teashop, I want to deliver clean and easy to read information about different types of tea that exist in the world.  Such as green, black, white and pu’er teas. As a business I want to give opportunity to my visitors personally try different types of tea by getting in touch with us trough contact form.    
...
## User stories  
### As a business owner:  
- I want to provide information about products I have  
...
### As a new customer:  
- As a user, I want have easy and intuitive navigation trough website
...
The website is set up to be used on as many devices as possible, this includes small mobile phones as well as extra-large 4k tv screens. Website has to be easy to navigate between sections by clicking required link in the navbar. Also includes easily accessible "contact me" form with acknowledgement message after completing and send.  
